...
#ifndef MIM_SOLVERS_CSQP_HPIPM_HPP_
#define MIM_SOLVERS_CSQP_HPIPM_HPP_
 ...
 * @brief HPIPM solver
 *
 * The HPIPM solver computes an optimal trajectory and control commands by iterates running `backwardPass()` and
 ...
 */
class SolverHPIPM : public SolverDDP {
 public:
  EIGEN_MAKE_ALIGNED_OPERATOR_NEW

  /**
   * @brief Initialize the HPIPM solver
   *
   * @param[in] problem  shooting problem
   */
  explicit SolverHPIPM(boost::shared_ptr<crocoddyl::ShootingProblem> problem);
  virtual ~SolverHPIPM();
...
#endif  // MIM_SOLVERS_CSQP_HPIPM_HPP_