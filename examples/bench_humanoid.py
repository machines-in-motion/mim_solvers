...
# python_path = pathlib.Path('/home/skleff/misc_repos/StagewiseSQP/analysis/constrained/')
# os.sys.path.insert(1, str(python_path))
# from qp_benchmark import create_humanoid_taichi_problem
# problem = create_humanoid_taichi_problem()
# N_ocp = problem.T


xs_init = [problem.x0] * (N_ocp + 1)
